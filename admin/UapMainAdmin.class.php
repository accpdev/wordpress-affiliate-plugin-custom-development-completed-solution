...
if (!class_exists('UapMainAdmin')){
	class UapMainAdmin{
		...
		public function add_style_scripts(){
			...
			wp_enqueue_style('uap_main_admin_style', UAP_URL . 'assets/css/main_admin.css', array(), 8.1 );
			if ($is_plugin_page){
				...
				wp_enqueue_style('uap_main_public_style', UAP_URL . 'assets/css/main_public.min.css', array(), 8.1 );
				wp_enqueue_style('uap_templates', UAP_URL . 'assets/css/templates.min.css', array(), 8.1 );
			}
			...
			wp_enqueue_media();
			wp_register_script('uap_admin_js', UAP_URL . 'assets/js/admin-functions.min.js', ['jquery'], 8.1 );
			...
			if ( $pagenow == 'plugins.php' ){
					...
					wp_enqueue_script( 'indeed_sweetalert_js', UAP_URL . 'assets/js/sweetalert.js', ['jquery'], 8.1 );
			...
			if ($is_plugin_page){
				...
				wp_enqueue_script('uap-jquery.flot.js', UAP_URL . 'assets/js/jquery.flot.js', array( 'jquery' ), 8.1 );
				wp_enqueue_script('uap-bootstrap.js', UAP_URL . 'assets/js/bootstrap.js', array('jquery'), 8.1 );
				wp_enqueue_script('uap-jquery.flot.pie.js', UAP_URL . 'assets/js/jquery.flot.pie.js', array('jquery'), 8.1 );
				wp_enqueue_script('uap-jquery_form_module', UAP_URL . 'assets/js/jquery.form.js', array('jquery'), 8.1 );
				wp_enqueue_script('uap-jquery.uploadfile', UAP_URL . 'assets/js/jquery.uploadfile.min.js', array('jquery'), 8.1 );
				wp_enqueue_script('uap-jquery.flot.time.js', UAP_URL . 'assets/js/jquery.flot.time.js', array('jquery'), 8.1 );
				wp_register_script('uap_public', UAP_URL . 'assets/js/public-functions.min.js', ['jquery'], 8.1 );
				...
				wp_enqueue_script( 'uap-select2', UAP_URL . 'assets/js/select2.min.js', array(), 8.1 );
