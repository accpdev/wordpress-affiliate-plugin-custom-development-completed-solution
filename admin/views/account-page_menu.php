...
foreach ($data['menu'] as $slug => $item):
		if ( $item['uap_tab_' . $slug . '_icon_code'] === false || $item['uap_tab_' . $slug . '_icon_code'] === '' )continue;
...
<form  method="post">
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php esc_html_e('Account Page - Customize Menu', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/account-custom-tabs/" target="_blank"><?php esc_html_e('Need Help?', 'uap');?></a></span></h3>
		<div class="inside">
	...
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php esc_html_e('Add new Menu Item', 'uap');?></h3>
		<div class="inside">
			<div class="uap-form-line">
				<div class="row">
					<div class="col-xs-4">
	...
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php esc_html_e('ReOrder Menu Items', 'uap');?></h3>
		<div class="inside">
				...
				<table class="wp-list-table widefat fixed tags uap-admin-tables" id="uap_reorder_menu_items">
					...
					<tbody>
						...
						<?php foreach ($data['menu'] as $slug=>$item):?>
							...
							<tr class="<?php echo ($k%2==0) ? 'alternate' : '';?>" id="tr_<?php echo $slug;?>">
								<td class="uap-slug-col"><input type="hidden" value="<?php echo $value;?>" name="uap_account_page_menu_order[<?php echo $slug;?>]" class="uap_account_page_menu_order" />
								<?php echo $slug;?></td>
