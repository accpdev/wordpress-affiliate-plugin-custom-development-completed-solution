<form  method="post">
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php esc_html_e('BuddyPress Account Page', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/woocommerce-buddypress-account-page-integration/" target="_blank"><?php esc_html_e('Need Help?', 'uap');?></a></span></h3>
		<div class="inside">
			<div class="uap-form-line">
			<div class="row">
				<div class="col-xs-7">
					<h2><?php esc_html_e('Activate/Hold Affiliate Section', 'uap');?></h2>
					<p><?php esc_html_e('Fully integrate a user "Affiliate Account" in their "BuddyPress Profile". Once activated, a new tab in their "BuddyPress" menu will show up.', 'uap');?></p>
