				...
				<div class="uap-stuffbox">
					...
					<div class="inside">
						...
						<div class="col-xs-6">
                            ...
                            <br/> <br/>
                            <p><?php esc_html_e('Once this module will be enabled Creatives (banners) listed on Account Page will have an additional code inside which will allow to track the Impressions. Affiliates will have to update their promotional banner codes to get this feature.', 'uap');?></p>
								...
								<div class="row">
									...
									<div class="input-group">
										<span class="input-group-addon"><?php echo $label;?></span>
									 		<input type="number" class="form-control uap-input-number" min="0" step='<?php echo uapInputNumerStep();?>' value="<?php echo $data['rank_value_array'][$id];?>" name="<?php echo "cpm_commission_value[$id]";?>" />
