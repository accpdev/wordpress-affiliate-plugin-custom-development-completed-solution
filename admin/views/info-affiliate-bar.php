<div class="uap-wrapper uap-admin-affiliate-bar-wrapper">
        ...
        <div class="uap-form-line">
					...
					<div class="form-group">
							<input type="text" class="form-control uap-edit-input" name="uap_info_affiliate_bar_logo" onClick="openMediaUp(this);" value="<?php echo $data['metas']['uap_info_affiliate_bar_logo'];?>" />
					...
					<div class="col-xs-4">
							...
							<div class="form-group">
									...
									<input type="text" class="form-control uap-edit-input"  name="uap_info_affiliate_bar_banner_default_value" onClick="openMediaUp(this);" value="<?php echo $data['metas']['uap_info_affiliate_bar_banner_default_value'];?>" />
