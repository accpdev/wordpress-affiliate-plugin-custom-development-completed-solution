			<form  method="post">
				<div class="uap-stuffbox">
					<h3 class="uap-h3"><?php esc_html_e('LifeTime Commissions', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/lifetime-commissions/" target="_blank"><?php esc_html_e('Need Help?', 'uap');?></a></span></h3>
					<div class="inside">
							...
							<table class="uap-dashboard-inside-table">
								...
								<?php foreach ($data['affiliate_referrals_table_data'] as $id=>$item) : ?>
									<tr>
										...
										<td><a href="<?php echo $data['edit_relation'] . '&id=' . $id;?>"><?php esc_html_e('Edit', 'uap');?></a> | <a href="<?php echo $data['current_url'] . '&delete=' . $id;?>"><?php esc_html_e('Delete', 'uap');?></a></td>
									</tr>
								<?php endforeach;?>
							</table>
						<?php endif;?>
