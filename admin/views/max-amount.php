<form  method="post">
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php esc_html_e('Maximum Amount', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/maximum-amount/" target="_blank"><?php esc_html_e('Need Help?', 'uap');?></a></span></h3>
		<div class="inside">
		<div class="row">
		  <div class="col-xs-5">
			<div class="uap-form-line">
				<h2><?php esc_html_e('Activate/Hold Maximum Amount', 'uap');?></h2>
			...
			<?php if (!empty($data['ranks'])):?>
				...
				<?php foreach ($data['ranks'] as $rank_data):?>
								<div class="input-group">
									<span class="input-group-addon"><?php echo $rank_data->label;?></span>
