<div class="uap-wrapper">
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php esc_html_e('AffiliateWP migration', 'uap');?></h3>
		<div class="inside">
		  <div class="row">
		  <div class="col-xs-5">
			<div class="uap-form-line">
            <h2><?php esc_html_e('Migrate from AffiliateWP script', 'uap');?></h2>
            <p><?php esc_html_e('Copy the Affiliate users and stored Referrals from AffiliateWP script. You can assign a specific UAP Rank to new copied affiliate users during this process.', 'uap'); ?></p>
        ...
        <span class="uap-trigger-event-migrate button button-primary button-large" data-type="affiliate-wp"><?php esc_html_e('Trigger', 'uap');?></span>
			</div>
