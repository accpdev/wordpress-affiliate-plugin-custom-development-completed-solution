				...
				<div class="uap-stuffbox">
					...
					<div class="inside">
						<div class="uap-form-line">
							<h2><?php esc_html_e('Enable Opt-In', 'uap');?></h2>
						...
						<div class="row">
							<div class="col-xs-6">
					           ...
					           <span class="input-group-addon"> <?php esc_html_e('Api URL', 'uap');?></span>
					            ...
					            <input type="text" value="<?php echo $data['metas']['uap_active_campaign_apiurl'];?>" name="uap_active_campaign_apiurl" class="form-control">
									</div>
								<div class="input-group">
					           <span class="input-group-addon"> <?php esc_html_e('Api Key:', 'uap');?></span>
					            <input type="text" value="<?php echo $data['metas']['uap_active_campaign_apikey'];?>" name="uap_active_campaign_apikey" class="form-control">
								</div>
								<div class="input-group">
					           <span class="input-group-addon"> <?php esc_html_e('List ID:', 'uap');?></span>
					            <input type="text" value="<?php echo $data['metas']['uap_active_campaign_listId'];?>" name="uap_active_campaign_listId" class="form-control">
								</div>
							</div>
						</div>
						<div id="uap_save_changes" class="uap-submit-form">
					...
					<div class="inside">
						...
						<div class="col-xs-6">
							<div class="input-group">
					            ...
					            <input type="text" value="<?php echo $data['metas']['uap_aweber_list'];?>" name="uap_aweber_list" class="form-control">
											</div>
					...
					<div class="inside">
						<div class="row">
						  <div class="col-xs-6">
						    <div class="input-group">
						         <span class="input-group-addon"><?php esc_html_e('API Key', 'uap');?></span>
					            <input type="text" value="<?php echo $data['metas']['uap_mailchimp_api'];?>" name="uap_mailchimp_api" class="form-control">
								</div>
					            ...
					            <input type="text" value="<?php echo $data['metas']['uap_mailchimp_id_list'];?>" name="uap_mailchimp_id_list" class="form-control">
								</div>
					...
					<div class="inside">
						<div class="row">
							<div class="col-xs-6">
					            ...
					            <input type="text" value="<?php echo $data['metas']['uap_getResponse_api_key'];?>" name="uap_getResponse_api_key" class="form-control">
					        </div>
					            ...
					            <input type="text" value="<?php echo $data['metas']['uap_getResponse_token'];?>" name="uap_getResponse_token" class="form-control">
									</div>
					...
					<div class="inside">
						<div class="row">
							<div class="col-xs-6">
					            ...
					            <input type="text" value="<?php echo $data['metas']['uap_cm_api_key'];?>" name="uap_cm_api_key" class="form-control">
					        </div>
					          ...
					          <div class="uap-form-line"></div>
					            ...
					            <input type="text" value="<?php echo $data['metas']['uap_cm_list_id'];?>" name="uap_cm_list_id" class="form-control">
					       </div>
					...
					<div class="inside">
						<div class="row">
							<div class="col-xs-6">
					            ...
					            <input type="text" value="<?php echo $data['metas']['uap_icontact_user'];?>" name="uap_icontact_user" class="form-control">
								</div>
								<div class="uap-form-line"></div>
								<div class="input-group">
					           <span class="input-group-addon"> iContact <?php esc_html_e('App ID', 'uap');?></span>
					            <input type="text" value="<?php echo $data['metas']['uap_icontact_appid'];?>" name="uap_icontact_appid" class="form-control">
								</div>
					       ...
					       <div class="input-group">
					            ...
					            <input type="text" value="<?php echo $data['metas']['uap_icontact_pass'];?>" name="uap_icontact_pass" class="form-control">
								 </div>
								 <div class="uap-form-line"></div>
					     	 <div class="input-group">
					           <span class="input-group-addon"> iContact <?php esc_html_e('List ID', 'uap');?></span>
					            <input type="text" value="<?php echo $data['metas']['uap_icontact_list_id'];?>" name="uap_icontact_list_id" class="form-control">
					      	</div>
				...
				<div class="inside">
					<div class="row">
						<div class="col-xs-6">
				            ...
				            <input type="text" value="<?php echo $data['metas']['uap_cc_user'];?>" id="uap_cc_user" name="uap_cc_user" class="form-control">
							</div>
				            ...
				            <input type="password" value="<?php echo $data['metas']['uap_cc_pass'];?>" id="uap_cc_pass" name="uap_cc_pass" class="form-control">
							</div>
							<div class="uap-form-line"></div>
				...
				<div class="inside">
					<div class="row">
						<div class="col-xs-6">
				            ...
				            <input type="text" value="<?php echo $data['metas']['uap_madmimi_username'];?>" name="uap_madmimi_username" class="form-control">
				       </div>
							 	<div class="uap-form-line"></div>
							<div class="input-group">
				             <span class="input-group-addon"><?php esc_html_e('Api Key:', 'uap');?></span>
				            <input type="text" value="<?php echo $data['metas']['uap_madmimi_apikey'];?>" name="uap_madmimi_apikey" class="form-control">
								</div>
								<div class="uap-form-line"></div>
				       <div class="input-group">
				             <span class="input-group-addon"><?php esc_html_e('List Name:', 'uap');?></span>
				            <input type="text" value="<?php echo $data['metas']['uap_madmimi_listname'];?>" name="uap_madmimi_listname" class="form-control">
				     		</div>
					<div id="uap_save_changes" class="uap-submit-form">
						<input type="submit" value="<?php esc_html_e('Save Changes', 'uap');?>" name="save" class="button button-primary button-large" />
					</div>
