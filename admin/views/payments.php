<div class="uap-wrapper">
	<div class="uap-page-title">Ultimate Affiliate Pro - <span class="second-text"><?php esc_html_e('UnPaid Referrals', 'uap');?></span></div>
	...
	<div class="uap-payments-stats">
		<div class="row">
			...
			<div class="col-xs-3 uap-payment-box3">
				<div class="uap-dashboard-top-box">
						...
						<tbody class="ui-sortable uap-alternate">
							...
							<tr>
								...
								<td><?php
									...
									if ($array['count_paid']){
										?>
										<div><a href="<?php echo $data['paid_referrals'] . '&affiliate=' . $id;?>"><?php esc_html_e('View', 'uap');?></a></div>
										<?php
									}
								?></td>
								<td><?php
									echo '<strong class="uap-special-color">'.$array['count_unpaid'].'</strong>';
									if (!empty($array['count_unpaid'])):
										?>
										<div><a href="<?php echo $data['unpaid_link'] . '&affiliate=' . $id;?>"><?php esc_html_e('View', 'uap');?></a></div>
										<?php
									endif;
								?></td>
								...
								<td><?php
									echo '<strong class="uap-special-color">' . uap_format_price_and_currency($array['unpaid_currency'], round($array['total_unpaid'], 2) ) . '</strong>';
									if (!empty($array['total_unpaid'])){
										?>
										<div><a href="<?php echo $data['pay_link'] . '&affiliate=' . $id;?>"><?php esc_html_e('Pay All', 'uap');?></a></div>
										<?php
									}
								?></td>
								<td><?php
									if ($array['has_transactions']){
										?>
											<div class="referral-status-verified"><a href="<?php echo $data['paid_link'] . '&affiliate=' . $id;?>"><?php esc_html_e('View', 'uap');?></a></div>
										<?php
									}
								?></td>
							</tr>
