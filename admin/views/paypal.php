<form  method="post">
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php  esc_html_e('PayPal - Payouts', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/paypal/" target="_blank"><?php  esc_html_e('Need Help?', 'uap');?></a></span></h3>
		<div class="inside">
					...
					<div class="col-xs-6">
						<div class="uap-js-paypal-sandbox-credentials  <?php echo ( !$data['metas']['uap_paypal_sandbox'] ) ? "uap-display-none" : '';?> ">
								<div class="uap-form-line">
									...
									<input type="text" name="uap_paypal_sandbox_client_id" value="<?php echo $data['metas']['uap_paypal_sandbox_client_id'];?>" class="form-control"/>
								</div>
								...
								<div class="input-group">
									...
									<input type="text" name="uap_paypal_sandbox_client_secret" value="<?php echo $data['metas']['uap_paypal_sandbox_client_secret'];?>" class="form-control"/>
								</div>
							</div>
						</div>
						...
						<div class="uap-js-paypal-live-credentials <?php echo ( $data['metas']['uap_paypal_sandbox'] ) ? "uap-display-none" : '';?>"  >
								<div class="uap-form-line">
									...
									<input type="text" name="uap_paypal_client_id" value="<?php echo $data['metas']['uap_paypal_client_id'];?>" class="form-control" />
								</div>
								...
								<div class="input-group">
									...
									<input type="text" name="uap_paypal_client_secret" value="<?php echo $data['metas']['uap_paypal_client_secret'];?>" class="form-control" />
								</div>
							</div>
						</div>
