			...
			<div class="uap-stuffbox">
				...
				<div class="row">
					...
					<div class="uap-form-line">
                        ...
                        <p><?php esc_html_e('Once the Module is enabled an extra sub-tab will be available on Account Page under "Marketing" main tab.', 'uap');?></p>
                       </div>
              </div>
						</div>
					...
					<div class="col-xs-4">
						...
						<select name="uap_product_links_source" >
								...
								<?php foreach ( $services as $serviceSlug => $serviceName ):?>
										<option value="<?php echo $serviceSlug;?>" <?php echo ( $serviceSlug == $data['metas']['uap_product_links_source'] ) ? 'selected' : '';?> ><?php echo $serviceName;?></option>
								<?php endforeach;?>
						</select>
          </div>
          </div>
