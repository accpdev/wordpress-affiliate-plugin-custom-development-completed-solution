<form  method="post">
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php esc_html_e('QR Codes', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/qr-codes/" target="_blank"><?php esc_html_e('Need Help?', 'uap');?></a></span></h3>
		<div class="inside">
			<div class="uap-form-line">
			<div class="row">
				<div class="col-xs-7">
					<h2><?php esc_html_e('Activate/Hold QR Codes into Account Page', 'uap');?></h2>
			...
			<div class="row">
				<div class="col-xs-6">
					...
					<input type="number" value="<?php echo $data['metas']['uap_qr_code_size'];?>" name="uap_qr_code_size" min="1" max="10" />
				</div>
			</div>
