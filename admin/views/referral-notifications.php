<form  method="post">
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php esc_html_e('Referral Notifications', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/referral-notifications/" target="_blank"><?php esc_html_e('Need Help?', 'uap');?></a></span></h3>
		<div class="inside">
			<div class="uap-form-line">
			<div class="row">
				<div class="col-xs-7">
					<h2><?php esc_html_e('Activate/Hold Referral Notifications', 'uap');?></h2>
					<p><?php esc_html_e('If this module is activated, affiliates have the option to receive instant notifications when they get new referrals. The affiliate can decide from his "Account Page" which type of referrals he will be notified of via email.', 'uap');?></p>
			...
			<div class="row">
				<div class="col-xs-6">
					...
					<input type="text" class="uap-field-text-with-padding form-control" name="uap_referral_notification_subject" value="<?php echo $data['metas']['uap_referral_notification_subject'];?>" />
				</div>
				</div>
			</div>
