...
<form  method="post">
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php esc_html_e('Account Page - REST API', 'uap');?></h3>
		<div class="inside">
					...
					<div class="uap-stuffbox">
						...
						<div class="inside">
							<div class="uap-form-line">
								...
								<p><?php echo '<strong>' . esc_html__('Method: ', 'uap') . '</strong>' . $array['method'];?></p>
								<p><?php echo '<strong>' . esc_html__('Arguments: ', 'uap') . '</strong>' . $array['args'];?></p>
