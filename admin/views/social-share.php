						...
						<div class="row">
								<div class="col-xs-7">
									...
									<label class="uap_label_shiwtch uap-switch-button-margin">
										...
										<input type="checkbox" class="uap-switch" onClick="uapCheckAndH(this, '#uap_social_share_enable_on_creatives');" <?php echo $checked;?> <?php echo (!$enabled) ? 'disabled' : '';?>/>
										<div class="switch uap-display-inline"></div>
									</label>
									<input type="hidden" name="uap_social_share_enable_on_creatives" value="<?php echo $data['metas']['uap_social_share_enable_on_creatives'];?>" id="uap_social_share_enable_on_creatives" />
								</div>
						</div>
