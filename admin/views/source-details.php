<form  method="post">
	...
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php esc_html_e('Source Details', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/source-details/" target="_blank"><?php esc_html_e('Need Help?', 'uap');?></a></span></h3>
		<div class="inside">
			<div class="uap-form-line">
			<div class="row">
				<div class="col-xs-7">
					<h2><?php esc_html_e('Activate/Hold Source Details into Account Page', 'uap');?></h2>
