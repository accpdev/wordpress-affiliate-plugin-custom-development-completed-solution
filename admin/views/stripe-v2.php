				...
				<div class="row">
						<div class="col-xs-7">
							...
							<?php $checked = ($data['metas']['uap_stripe_v2_enable']) ? 'checked' : '';?>
								<input type="checkbox" class="uap-switch" onClick="uapCheckAndH(this, '#uap_stripe_v2_enable');" <?php echo $checked;?> disabled />
					...
					<div class="col-xs-6">
						<div class="uap-form-line">
							...
							<label class="input-group-addon"><?php esc_html_e('Sandbox Secret Key', 'uap');?></label>
								<input type="text" name="uap_stripe_v2_sandbox_secret_key" value="<?php echo $data['metas']['uap_stripe_v2_sandbox_secret_key'];?>" / class="form-control">
						 </div>
						 <div class="uap-form-line"></div>
						 <div class="input-group">
							<label class="input-group-addon"><?php esc_html_e('Sandbox Publishable Key', 'uap');?></label>
							<input type="text" name="uap_stripe_v2_sandbox_publishable_key" value="<?php echo $data['metas']['uap_stripe_v2_sandbox_publishable_key'];?>" class="form-control" />
							</div>
							<div class="uap-form-line"></div>
							<div class="input-group">
							<label class="input-group-addon"><?php esc_html_e('Live Secret Key', 'uap');?></label>
								<input type="text" name="uap_stripe_v2_secret_key" value="<?php echo $data['metas']['uap_stripe_v2_secret_key'];?>" class="form-control" />
							</div>
							<div class="uap-form-line"></div>
							<div class="input-group">
							<label class="input-group-addon"><?php esc_html_e('Live Publishable Key', 'uap');?></label>
								<input type="text" name="uap_stripe_v2_publishable_key" value="<?php echo $data['metas']['uap_stripe_v2_publishable_key'];?>" class="form-control" />
							</div>
