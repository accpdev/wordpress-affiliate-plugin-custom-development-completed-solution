        	...
        	<div class="uap-row ">
            	<div class="uap-col-xs-8">
                	...
                	<?php if (empty($data['print_username'])): ?>
						<span><?php esc_html_e("Tracking ID:", 'uap');?></span> <span class=" uap-special-label"><?php echo $data['affiliate_id'];?></span>
					<?php else:?>
                    ...
                    <div class="uap-account-affiliatelinks-tab2">
        				<span><?php esc_html_e("Default Affiliate Link:", 'uap');?></span> <span class=" uap-special-label"><a href="<?php echo $data['home_url'];?>" target="_blank"><?php echo $data['home_url'];?></a></span>
                	</div>
                </div>
