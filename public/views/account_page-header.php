...
<?php foreach ($data['available_tabs'] as $k=>$v):
        if ( !isset( $v['uap_tab_' . $k . '_icon_code'] ) || $v['uap_tab_' . $k . '_icon_code'] === '' ) continue;
...
<?php wp_enqueue_script( 'uap-account_page-banner', UAP_URL . 'assets/js/account_page-banner.js', ['jquery'], 8.1 );?>
