<?php
wp_enqueue_script( 'indeed_sweetalert_js', UAP_URL . 'assets/js/sweetalert.js', [], 8.1 );
								...
								<table class="uap-account-table">
									<thead>
										<tr>
											...
											<th><?php esc_html_e("Date Created", 'uap');?></th>
									...
									<?php foreach ($data['affiliate_links'] as $array) : ?>
										<tr>
											<td><a href="<?php echo $array['base_url'];?>" target="_blank"><?php echo $array['base_url'];?></a></td>
											<td><?php echo $array['affiliate_url'];?></td>
											<td><?php echo $array['campaign'];?></td>
											<td><?php
											$date = new \DateTime();
											...
											<td><span class="uap-js-list-affiliate-links-copy" data-confirm="<?php esc_html_e( 'copied to clipboard', 'uap' );?>" data-link="<?php echo $array['affiliate_url'];?>" ><?php esc_html_e("Copy Link", 'uap');?></span> <span class="uap-js-list-affiliate-links-remove" data-id="<?php echo $array['id'];?>"><?php esc_html_e("Remove", 'uap');?></span></td>
										</tr>
									<?php endforeach;?>
									</tbody>
								</table>
