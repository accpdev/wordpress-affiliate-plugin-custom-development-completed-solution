...
<?php endif;?>
	<div class="uap-row">
		<div class="uapcol-md-3 uap-account-visits-tab1">
			<div class="uap-account-no-box uap-account-box-lightgray"><div class="uap-account-no-box-inside"><div class="uap-count"><?php echo $data['stats']['visits'];?></div><div class="uap-detail"><?php esc_html_e('Total Numbers of Clicks', 'uap');?></div>
		...
		<div class="uapcol-md-3 uap-account-visits-tab2">
			<div class="uap-account-no-box uap-account-box-red"><div class="uap-account-no-box-inside"><div class="uap-count"><?php echo $data['stats']['conversions'];?></div><div class="uap-detail"><?php esc_html_e('Conversions', 'uap');?></div>
		...
		<div class="uapcol-md-3 uap-account-visits-tab3">
			<div class="uap-account-no-box uap-account-box-lightblue"><div class="uap-account-no-box-inside"><div class="uap-count"><?php echo $data['stats']['success_rate'] . ' %';?></div><div class="uap-detail"><?php esc_html_e('Success Rate', 'uap');?></div></div></div>
		</div>
	</div>
			...
			<?php foreach ($data['items'] as $array) : ?>
				<tr>
					...
					<?php if ( isset( $array['ref_url'] ) && $array['ref_url'] !== '' ):?>
							<td><a href="<?php echo $array['ref_url'];?>" target="_blank"><?php echo $array['ref_url'];?></a></td>
					<?php else :?>
							<td>-</td>
					<?php endif;?>
