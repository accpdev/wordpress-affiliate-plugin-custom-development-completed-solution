...
<div class="uap-ap-wrap">
	...
	<?php endif;?>
		...
		<?php if (!empty($data['items'])):?>
			...
			<?php wp_enqueue_script( 'uap-gstatic-charts', 'https://www.gstatic.com/charts/loader.js', ['jquery'], 8.1 );?>
			<?php wp_enqueue_script( 'uap-public-mlm', UAP_URL . 'assets/js/public-mlm.js', ['jquery'], 8.1 );?>
			...
			<span class="uap-js-mlm-view-affiliate-children-parent-data"
						...
						data-parent_full_name="<?php echo isset( $data['parent_full_name'] ) ? $data['parent_full_name'] : '';?>"
