...
<?php wp_enqueue_style( 'uap-croppic_css', UAP_URL . 'assets/css/croppic.css', array(), 8.1 );?>
<?php wp_enqueue_script( 'uap-jquery_mousewheel', UAP_URL . 'assets/js/jquery.mousewheel.min.js', ['jquery'], 8.1 );?>
<?php wp_enqueue_script( 'uap-croppic', UAP_URL . 'assets/js/croppic.js', ['jquery'], 8.1 );?>
<?php wp_enqueue_script( 'uap-image_croppic', UAP_URL . 'assets/js/image_croppic.js', ['jquery'], 8.1 );?>
<?php wp_enqueue_script( 'uap-public-upload-image', UAP_URL . 'assets/js/public-upload-image.js', ['jquery'], 8.1 );?>
<?php
...
data-save_image_target="<?php echo $ajaxURL;?>"
data-crop_image_target="<?php echo $ajaxURL;?>"
